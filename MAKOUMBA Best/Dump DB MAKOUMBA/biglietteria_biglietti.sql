...
CREATE TABLE `biglietti` (
  `cod_operazione` varchar(255) NOT NULL,
  `data` date DEFAULT NULL,
  `quantita` int NOT NULL,
  `tipo_pagamento` varchar(255) DEFAULT NULL,
  `replica_cod_replica` varchar(255) DEFAULT NULL,
  `cod_cliente` bigint DEFAULT NULL,
  PRIMARY KEY (`cod_operazione`),
  UNIQUE KEY `UKfoq9ponr1v5n56y3rcjf3v2s7` (`replica_cod_replica`),
  ...
  CONSTRAINT `FKt6a5pj0ubl5dfph06xodvbyn2` FOREIGN KEY (`replica_cod_replica`) REFERENCES `repliche` (`cod_replica`)
